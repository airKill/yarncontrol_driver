...
unsigned char SMEC_Sha1Auth(unsigned char *pbSha1Key, unsigned char bSha1KeyLen, unsigned char *pbRandom, unsigned char bRandomLen)
{
  ...
  SHA1Init((void *) &Sha1_Context );
  SHA1Update((void *)&Sha1_Context, pbSha1Key, bSha1KeyLen);		//先把pbSha1Key进行运算
  SHA1Update((void *)&Sha1_Context, pbRandom, bRandomLen);
  SHA1Final(bHashData2, (void *)&Sha1_Context);					//算出结果
