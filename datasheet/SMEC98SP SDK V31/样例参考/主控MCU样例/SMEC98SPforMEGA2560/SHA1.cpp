...
void SHA1Init( void *p)  
{
  SHA1_CTX *context = (SHA1_CTX *)p;
...
void SHA1Update(void *p, unsigned char * const dat, unsigned int len )  
{
  unsigned  short i;
  unsigned char j;	
  SHA1_CTX *context = (SHA1_CTX *)p;
...
void SHA1Final( unsigned char * digest /*[20]*/, void *p)  
{	
  unsigned char i;
