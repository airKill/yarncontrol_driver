...
#define GPIO_PORT_STEPMOTOR1_EN      GPIOE
#define GPIO_PIN_STEPMOTOR1_EN	 GPIO_Pin_9
...
#define RCC_STEPMOTOR3_EN 	 (RCC_AHB1Periph_GPIOA | RCC_AHB1Periph_GPIOC | RCC_AHB1Periph_GPIOE)
...
//#define GPIO_PORT_STEPMOTOR3_DIR      GPIOC
//#define GPIO_PIN_STEPMOTOR3_DIR	 GPIO_Pin_4
#define GPIO_PORT_STEPMOTOR3_CP      GPIOA
#define GPIO_PIN_STEPMOTOR3_CP	 GPIO_Pin_1
//#define GPIO_PORT_STEPMOTOR3_CP      GPIOE
//#define GPIO_PIN_STEPMOTOR3_CP	 GPIO_Pin_14

#define STEPMOTOR1_EN_H()     GPIO_SetBits(GPIO_PORT_STEPMOTOR1_EN,GPIO_PIN_STEPMOTOR1_EN)
#define STEPMOTOR1_EN_L()     GPIO_ResetBits(GPIO_PORT_STEPMOTOR1_EN,GPIO_PIN_STEPMOTOR1_EN)
#define STEPMOTOR2_EN_H()     GPIO_SetBits(GPIO_PORT_STEPMOTOR2_EN,GPIO_PIN_STEPMOTOR2_EN)
#define STEPMOTOR2_EN_L()     GPIO_ResetBits(GPIO_PORT_STEPMOTOR2_EN,GPIO_PIN_STEPMOTOR2_EN)
